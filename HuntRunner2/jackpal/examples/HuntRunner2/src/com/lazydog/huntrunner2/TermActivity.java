...
//NOTE: need to use high port number due to SELinux security restrictions...
        ProcessBuilder execBuild =
                new ProcessBuilder(execPath, "/system/bin/sh", "-c", "TERM=vt100 TERMINFO="+HuntRunner2Activity.getDataDir(this)+" ROWS=24 COLS=80 "+huntPath+" -p 9998 "+hostname);
