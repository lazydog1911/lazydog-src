...
{
 return ((parm_ich != 0) ? SP->_ich_cost : ((enter_insert_mode && exit_insert_mode) ? SP->_smir_cost + SP->_rmir_cost + (SP->_ip_cost * count) : ((insert_character != 0) ? (SP->_ich1_cost * count) : 1000000)));
}
