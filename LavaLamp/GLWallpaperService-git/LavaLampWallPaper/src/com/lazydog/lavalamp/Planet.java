...
//    			boolean imageId, int earthID, int bumpmapID) 
    {
        ...
        GL10 gl = null; //XXX- NOT USED
        Context context = null;
        boolean imageId = false;
        int earthID = -1;
        int bumpmapID = -1;
    	...
    	for(phiIdx=0; phiIdx < m_Stacks; phiIdx++)		    		
    	{
    		...
    		for(thetaIdx=0; thetaIdx < m_Slices; thetaIdx++)			
    		{
 			...
 			colorData[cIndex+1] = (float)0f;
    			...
    			colorData[cIndex+3] = (float)0.3f; //alpha
/*
colorData[cIndex+0] = 1.0f;
colorData[cIndex+1] = 1.0f;
colorData[cIndex+2] = 0.0f;
...
*/
    			...
    			colorData[cIndex+7] = (float)0.3f; //alpha
/*
colorData[cIndex+4] = 1.0f;
colorData[cIndex+5] = 1.0f;
colorData[cIndex+6] = 0.0f;
...
//gl.glDisableClientState(GL10.GL_NORMAL_ARRAY);
         ...
         //gl.glDrawArrays(GL10.GL_LINES, 0, (m_Slices+1)*2*(m_Stacks-1)+2);
//         gl.glDrawArrays(GL10.GL_TRIANGLE_STRIPS, 0, (m_Slices+1)*2*(m_Stacks-1)+2);

gl.glBlendFunc(GL10.GL_SRC_ALPHA, GL10.GL_ONE_MINUS_SRC_ALPHA);
gl.glEnable(GL10.GL_BLEND);   
gl.glDrawArrays(GL10.GL_TRIANGLE_STRIP, 0, (m_Slices+1)*2*(m_Stacks-1)+2);

//gl.glDrawElements(GL11.GL_TRIANGLES, (m_Slices+1)*2*(m_Stacks-1)+2 , GL11.GL_UNSIGNED_BYTE, mapping_of_indicies_to_triangles )
